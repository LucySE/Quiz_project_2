...
/* WEBPACK VAR INJECTION */(function($) {console.log('HELLO JS');
$(document).ready(function () {
  // Ensure JQuery added
  console.log($); // Test to show that we can change the text

  var $hello = $('#hello');
  console.log($hello.text());
  $hello.text('Banana'); // Display the question

  var $question = $('#question'); // Retrieve the question for display 
  // Display radio buttons with options

  console.log(gon.hello);
});
...
/******/ });
//# sourceMappingURL=game-9ba4172e0252cbace136.js.map